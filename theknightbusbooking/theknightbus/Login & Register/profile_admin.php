    ...
    <body>
        ...
        <div class = "box" style = "position: fixed; right: 100px; left: 100px; top: 67px;">
            ...
            <ul class = "nav__links" style = "width: 200px; height: 20px; margin: 0 auto; position: relative; right: 20px; margin-bottom: 10px;">
                <li><a href = "edit_admin.php" style = "font-size: 1rem; line-height: 2rem;"><button name = "update" style = "background: white; color: black; width: 200px; height: 40px; padding: 0px; margin: 0 auto;">Edit Profile ‎ ‎ <i class="far fa-edit"></i></a></li><br>
        </div>
