...
<!DOCTYPE html>
    <head>
        ...
        <title>Edit Profile | The Knight Bus Booking</title>
    ...
    <body>
        ...
        <div class = "box" style = "position: fixed; top: 55px; left: 100px; right: 100px;">
            ...
            <form action="edit_profile.php" method="POST" class="login-email">
                <br>
                ...
                <br><ul class = "nav__links" style = "width: 200px height: 20px;">
                    <li><a style = "font-size: 0.98rem"><button name = "update" href = "profile.php" style = "background: white; color: black; width: 150px; height: 40px; padding-top: 5px; padding-bottom: 5px; margin: 0 auto;">Update ‎ ‎ <i class="far fa-edit"></i></a></li>
                </ul>
            </form>
        </div>
